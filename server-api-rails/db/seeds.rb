...
generate_privilege    = Privilege.create! name: 'GENERATE_PRIVILEGE'
import_privilege      = Privilege.create! name: 'IMPORT_PRIVILEGE'
...
Role.create! name: 'ROLE_COLORS'          , privileges: [ read_privilege, create_privilege, update_privilege, delete_privilege, import_privilege ]
Role.create! name: 'ROLE_MATERIALS'       , privileges: [ read_privilege, create_privilege, update_privilege, delete_privilege, import_privilege ]
...
Role.create! name: 'ROLE_REPORTS'         , privileges: [ read_privilege, generate_privilege ]
Role.create! name: 'ROLE_SOLAR_RADIATIONS', privileges: [ read_privilege, create_privilege, update_privilege, delete_privilege, import_privilege ]
